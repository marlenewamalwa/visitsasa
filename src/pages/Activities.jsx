...
export default function Activities() {
  ...
  const [savedIds,      setSavedIds]      = useState(new Set()); // activity_id set
  ...
  // Load saved activity IDs for current user
    ...
    <div style={S.page}>
      ...
      <section style={{ ...S.hero, backgroundImage: `url(${acthero})` }}>
        ...
        <div style={S.heroContent}>
          ...
          <p style={S.heroSub}>
            Handpicked activities across Kenya — from dawn game drives on the Mara to
            coral reef dives off the coast.
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={S.cardBody}>
                      ...
                      {/* Expanded: best for destinations */}
      ...
      <section style={S.ctaStrip}>
        <div style={S.ctaInner}>
          <div>
            ...
            <p style={S.ctaSub}>Mix and match activities into a custom itinerary — our team will handle everything else.</p>
          </div>
...
const S = {
  ...
  addTripBtn:  { padding: "9px 18px", backgroundColor: "#204E59", color: "#fff", border: "none", cursor: "pointer", fontFamily: "'Helvetica Neue', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", transition: "all 0.2s" },
...
const css = `
  ...
  .add-trip-act-btn:hover { background: #163640 !important; transform: translateY(-1px); }
